...
//			/	output.print(thisStr);
	...
	public void close() {
		this.output.close();
		/*
		 * try { this.xlsxPackage.close(); } catch (IOException e) {
		 * e.printStackTrace(); } this.output.close();
		 */
	}

	public static void main(String[] args) throws Exception {
		XLSX2CSV xlsx2csv = new XLSX2CSV("c:\\cs2.xlsx", "c:\\outs.csv");
		xlsx2csv.process();
	}
